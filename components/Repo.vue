<template>
  <v-card id="repoInfoCard" xs10 offset-xs1>
    ...
    <v-chip
      v-for="topic in repoInformation.topics"
      :small="true"
      :key="topic"
      color="grey darken-2"
      >{{ topic }}</v-chip
    >
    <v-divider id="topic-desc-divider" />
    ...
    <span id="chips" xs10 offset-xs1>
      ...
      <a :href="repoInformation.html_url" class="github-link" target="_blank">
        <v-chip
          :title="'Take me to ' + repoInformation.name + ' on GitHub!'"
          class="chip"
